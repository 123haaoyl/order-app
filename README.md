...
- 当前内置菜单扩展为 100 道菜，包含福州菜、烟台山新派、家常热炒、下饭小碗菜、年轻人爱吃、韩式日式小食、焗烤炸物、粉面饭主食、轻食沙拉、宵夜烧烤等分类；更换 `SHOP_CONFIG.menuVersion` 会自动清理旧的本地菜品编辑缓存。
...
- 菜品管理可新增、删除、编辑分类、价格、库存、上架状态；新增菜品可选择 icon、分类和自定义规格，线上部署后会通过 Neon 同步到顾客端。
